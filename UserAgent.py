import random
UserAgent={'1':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36 OPR/26.0.1656.60',
           ...
           '12':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.11 (KHTML, like Gecko) Chrome/20.0.1132.11TaoBrowser/2.0 Safari/536.11',
...
proxy_ip = [
    {'http':'115.218.124.239:9000'},
    {'http':'117.87.176.140:9000'},
    {'http':'60.184.201.172:9000'},
    {'http':'115.223.216.62:9000'},
    {'http':'180.118.33.123:9000'},
    {'http':'115.218.121.20:9000'}
    ]
def randomUserAgent():
    a = str(random.randint(1,21))
    UserA = UserAgent[a]
    return UserA
def randomIP():
...
淘宝浏览器
Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.11 (KHTML, like Gecko) Chrome/20.0.1132.11TaoBrowser/2.0 Safari/536.11
